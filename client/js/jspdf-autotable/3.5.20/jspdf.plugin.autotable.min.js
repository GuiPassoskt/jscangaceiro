  ...
  return (() => {
    ...
    var e = {
          ...
          e.default = function (t) {
            (t.API.autoTable = function () {
              ...
              (t.API.autoTableAddPage = function () {
                return (
                  console.error('Use of deprecated function: autoTableAddPage. Use doc.addPage()'), this.addPage(), this
                );
              });
          };
        },
          ...
          Object.defineProperty(e, '__esModule', { value: !0 }),
            (e.default = function (t, e, n, o, r) {
              ...
              var i = 1.15,
                ...
                u = 1;
              if (
                (('middle' !== o.valign && 'bottom' !== o.valign && 'center' !== o.halign && 'right' !== o.halign) ||
                  (u = (s = 'string' == typeof t ? t.split(/\r\n|\r|\n/g) : t).length || 1),
                (n += a * (2 - i)),
                'middle' === o.valign ? (n -= (u / 2) * a * i) : 'bottom' === o.valign && (n -= u * a * i),
              ...
              return (
                'justify' === o.halign
                  ? r.text(t, e, n, { maxWidth: o.maxWidth || 100, align: 'justify' })
                  : r.text(t, e, n),
                r
              );
            });
          ...
          Object.defineProperty(e, '__esModule', { value: !0 }),
            ...
            (e.parseSpacing = function (t, e) {
              ...
              return 'object' == typeof t
                ? ('number' == typeof t.vertical && ((t.top = t.vertical), (t.bottom = t.vertical)),
                  'number' == typeof t.horizontal && ((t.right = t.horizontal), (t.left = t.horizontal)),
                  {
                ...
                : ('number' != typeof t && (t = e), { top: t, right: t, bottom: t, left: t });
            });
        },
        913: function (t, e) {
          var n,
        ...
        259: (t, e, n) => {
          ...
          function i(t, e) {
            var n = e(t);
            return 'rgba(0, 0, 0, 0)' === n || 'transparent' === n || 'initial' === n || 'inherit' === n
          ...
          e.parseCss = function (t, e, n, i, l) {
            ...
            -1 !== p.indexOf(i.textAlign) && (a.halign = i.textAlign),
              -1 !== (p = ['middle', 'bottom', 'top']).indexOf(i.verticalAlign) && (a.valign = i.verticalAlign);
              ...
              return (
                ...
                (t.prototype.applyStyles = function (e, n) {
                  ...
                  if ((e.font && (s = e.font), e.fontStyle)) {
                    ...
                    u &&
                      -1 === u.indexOf(a) &&
                      (this.jsPDFDocument.setFontStyle && this.jsPDFDocument.setFontStyle(u[0]), (a = u[0]));
                  }
                  if (
                    (this.jsPDFDocument.setFont(s, a), e.fontSize && this.jsPDFDocument.setFontSize(e.fontSize), !n)
                  ) {
                    var d = t.unifyColor(e.fillColor);
                    d && (o = this.jsPDFDocument).setFillColor.apply(o, d),
                      (d = t.unifyColor(e.textColor)) && (r = this.jsPDFDocument).setTextColor.apply(r, d),
                      (d = t.unifyColor(e.lineColor)) && (i = this.jsPDFDocument).setDrawColor.apply(i, d),
                ...
                (t.prototype.pageSize = function () {
                  ...
                  return null == t.width && (t = { width: t.getWidth(), height: t.getHeight() }), t;
                }),
        ...
        148: (t, e, n) => {
            ...
            for (var u = new r.HtmlRowInput(i), d = 0; d < i.cells.length; d++) {
              ...
              if (a || 'none' !== c.display) {
                ...
                s && (f = o.parseCss(t, h, e, c, n)),
                  u.push({ rowSpan: h.rowSpan, colSpan: h.colSpan, styles: f, _element: h, content: l(h) });
              }
            }
          ...
          e.parseHtml = function (t, e, n, o, r) {
            ...
            var u = Object.keys(t.getFontList()),
              ...
              f = [];
            if (!s)
              return console.error('Html table could not be found with input: ', e), { head: h, body: c, foot: f };
            for (var p = 0; p < s.rows.length; p++) {
              var g = s.rows[p],
                y =
                  null ===
                    (a = null === (l = null == g ? void 0 : g.parentElement) || void 0 === l ? void 0 : l.tagName) ||
                  void 0 === a
                    ? void 0
                    : a.toLowerCase(),
                v = i(u, d, n, g, o, r);
        ...
        587: (t, e, n) => {
            ...
            return (
              Object.keys(o)
                ...
                .forEach(function (t) {
                  var e,
                    n = 1;
                  'object' != typeof (e = Array.isArray(o) ? o[parseInt(t)] : o[t]) ||
                    Array.isArray(e) ||
          ...
          e.parseInput = function (t, e) {
            ...
            var f = (function (t, e, n) {
              ...
              p = (function (t, e, n) {
                for (
                  var o = { didParseCell: [], willDrawCell: [], didDrawCell: [], didDrawPage: [] },
                    r = 0,
                    i = [t, e, n];
                  r < i.length;
                  r++
              ...
              g = (function (t, e) {
                var n,
                  ...
                  p,
                  g,
                  y = i.parseSpacing(e.margin, 40 / t.scaleFactor()),
                  v =
                    null !==
                      (n = (function (t, e) {
                        ...
                        if ((null == e || !1 === e) && i && null != (null == n ? void 0 : n.finalY))
            ...
            (e.default = function (t, e, o, r) {
              for (
                var i = function (e) {
                    e &&
                      'object' != typeof e &&
                      console.error('The options parameter should be of type object, is: ' + typeof e),
                      ...
                      e.startY &&
                        ...
                        (console.error('Invalid value for startY option', e.startY), delete e.startY),
                      !e.didDrawPage &&
                        (e.afterPageContent || e.beforePageContent || e.afterPageAdd) &&
                        (console.error(
                      ...
                      ['createdHeaderCell', 'drawHeaderRow', 'drawRow', 'drawHeaderCell'].forEach(function (t) {
                        e[t] &&
                          console.error(
                            'The "' + t + '" hook has changed in version 3.0, check the changelog for how to migrate.'
                          );
                      }),
                      [
                        ['showFoot', 'showFooter'],
                        ...
                        var n = t[0],
                          o = t[1];
                        e[o] &&
                          (console.error('Use of deprecated option ' + o + '. Use ' + n + ' instead'), (e[n] = e[o]));
                      }),
                      [['padding', 'cellPadding'], ['lineHeight', 'rowHeight'], 'fontSize', 'overflow'].forEach(
                        function (t) {
                          var n = 'string' == typeof t ? t : t[0],
                            o = 'string' == typeof t ? t : t[1];
                          void 0 !== e[n] &&
                            (void 0 === e.styles[o] && (e.styles[o] = e[n]),
                            console.error('Use of deprecated option: ' + n + ', use the style ' + o + ' instead.'));
                        }
                      );
          ...
          var a = (function () {
            function t(t, e, n, r, i) {
              void 0 === i && (i = !1),
                (this.height = 0),
                (this.raw = t),
                t instanceof o.HtmlRowInput && ((this.raw = t._element), (this.element = t._element)),
                (this.index = e),
                (this.section = n),
                (this.cells = r),
          ...
          var s = (function () {
            function t(t, e, n) {
              ...
              null == t || 'object' != typeof t || Array.isArray(t)
                ...
                : ((this.rowSpan = t.rowSpan || 1),
                  ...
                  (i = null !== (r = null !== (o = t.content) && void 0 !== o ? o : t.title) && void 0 !== r ? r : t),
            ...
            return (
              ...
              (t.prototype.getContentHeight = function (t) {
                var e =
                  (Array.isArray(this.text) ? this.text.length : 1) * ((this.styles.fontSize / t) * o.FONT_ROW_RATIO) +
              ...
              for (var u = 0, h = {}, c = 0, f = 0, p = 0, g = n; p < g.length; p++) {
                ...
                if (null == a[y.index] || 0 === a[y.index].left)
                  if (0 === f) {
                    var v = void 0,
                      m = {};
                    'object' != typeof (v = Array.isArray(e) ? e[y.index - c - u] : e[y.dataKey]) ||
                      Array.isArray(v) ||
                  ...
                  o = (function (t) {
                    return t.map(function (t, e) {
                      ...
                      return (
                        (i =
                          'object' == typeof t &&
                          null !== (o = null !== (n = t.dataKey) && void 0 !== n ? n : t.key) &&
                          void 0 !== o
                            ? o
                            : e),
                        new r.Column(i, t, e)
        ...
        49: (t, e, n) => {
                ...
                for (var l = 0, s = 0, u = n.columns; s < u.length; s++) {
                  ...
                  if ((m = t.cells[h.index])) {
                    ...
                    (m.contentHeight = m.getContentHeight(p)),
                      m.contentHeight >= e && ((m.contentHeight = e), (c.styles.minCellHeight -= e)),
                      m.contentHeight > t.height && (t.height = m.contentHeight),
          ...
          function f(t, e, n) {
            var o = e.styles;
            if ('number' == typeof o.lineWidth) {
              var i = r.getFillStyle(o.lineWidth, o.fillColor);
              i && t.rect(e.x, n.y, e.width, e.height, i);
            } else if ('object' == typeof o.lineWidth) {
              var l = Object.keys(o.lineWidth),
                a = o.lineWidth;
              l.map(function (i) {
                var l = r.getFillStyle(a[i], o.fillColor);
                !(function (t, e, n, o, r, i) {
                  ...
                  switch (o) {
                    ...
                    case 'right':
                      ...
                      break;
                    default:
                      (l = n.x), (a = n.y + e.height), (s = n.x + e.width), (u = n.y + e.height);
                  }
                      ...
                      t.applyStyles(t.userStyles),
                        i > 0
                          ...
                          : (function (t, e, n, o) {
                              var r = e.settings;
                              t.applyStyles(t.userStyles),
                                ('firstPage' === r.showHead || 'everyPage' === r.showHead) &&
                        ...
                        (function (t, e, n, o) {
                          var r = e.settings;
                          t.applyStyles(t.userStyles),
                            ('lastPage' === r.showFoot || 'everyPage' === r.showFoot) &&
        ...
        435: (t, e, n) => {
          ...
          var o = n(200),
            r = function (t, e) {
              var n = o.parseSpacing(e.settings.margin, 0);
            ...
            i = function (t, e, n) {
              ...
              for (
                ...
                (a.push(l.index), s.push(e.columns[l.index]), (o -= l.wrappedWidth));
                d < u;
          ...
          function l(t, e, n, r, i) {
            return t.map(function (t) {
              return (function (t, e, n, r, i) {
                ...
                if ((e = Math.ceil(e * l) / l) >= o.getStringWidth(t, n, r)) return t;
                for (; e < o.getStringWidth(t + i, n, r) && !(t.length <= 1); ) t = t.substring(0, t.length - 1);
                return t.trim() + i;
              })(t, e, n, r, i);
            });
          }
          (e.calculateWidths = function (t, e) {
              ...
              e.allRows().forEach(function (r) {
                for (var a = 0, s = e.columns; a < s.length; a++) {
                  ...
                  if (d) {
                    ...
                    d.contentWidth = o.getStringWidth(d.text, d.styles, t) + c;
                    var f = o.getStringWidth(d.text.join(' ').split(/\s+/), d.styles, t);
                    if (((d.minReadableWidth = f + d.padding('horizontal')), 'number' == typeof d.styles.cellWidth))
                      (d.minWidth = d.styles.cellWidth), (d.wrappedWidth = d.styles.cellWidth);
                    else if ('wrap' === d.styles.cellWidth || !0 === i)
                      d.contentWidth > l
                        ? ((d.minWidth = l), (d.wrappedWidth = l))
                        : ((d.minWidth = d.contentWidth), (d.wrappedWidth = d.contentWidth));
                    else {
                      var p = 10 / n;
                      (d.minWidth = d.styles.minCellWidth || p),
                        (d.wrappedWidth = d.contentWidth),
                        d.minWidth > d.wrappedWidth && (d.wrappedWidth = d.minWidth);
                    }
                  }
                }
              }),
                  ...
                  for (var n = 0, o = e.columns; n < o.length; n++) {
                    ...
                    if (i && 1 === i.colSpan)
                      (r.wrappedWidth = Math.max(r.wrappedWidth, i.wrappedWidth)),
                        ...
                        (r.minReadableWidth = Math.max(r.minReadableWidth, i.minReadableWidth));
                    else {
                    ...
                    i &&
                      ...
                      i.colSpan > 1 && !r.wrappedWidth && (r.wrappedWidth = i.minWidth));
                  }
                });
            })(t, e);
            var n = [],
            ...
            s &&
              ...
              !e.settings.horizontalPageBreak &&
                ...
                console.error('Of the table content, ' + s + ' units width could not fit page')),
              (function (t) {
                  ...
                  for (var i = r[o], a = 0, s = t.columns; a < s.length; a++) {
                    ...
                    if (d) {
                      ...
                      'linebreak' === d.styles.overflow
                        ? (d.text = e.splitTextToSize(d.text, h + 1 / e.scaleFactor(), { fontSize: d.styles.fontSize }))
                        : 'ellipsize' === d.styles.overflow
                        ? (d.text = l(d.text, h, d.styles, e, '...'))
                        : 'hidden' === d.styles.overflow
                        ? (d.text = l(d.text, h, d.styles, e, ''))
                        : 'function' == typeof d.styles.overflow && (d.text = d.styles.overflow(d.text, h)),
      ...
      (() => {
        ...
        Object.defineProperty(t, 'Cell', {
          ...
          (t.default = function (t, e) {
            var o = n.parseInput(t, e),
              r = l.createTable(t, o);
            i.drawTable(t, r);
          }),
          (t.__createTable = function (t, e) {
            var o = n.parseInput(t, e);
            return l.createTable(t, o);
          }),
